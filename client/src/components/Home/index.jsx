    ...
    return (
        <div className="all">
            ...
            <div>
                ...
                <div>
                    <SearchBar></SearchBar>
                    <Paginado charactersPerPage={charactersPerPage} allCharacters={allCharacters.length} paginado={paginado}></Paginado>
                </div>
            </div>
            <div
                style={{
                    ...
                    return (
                        <>
                            <Link to={"/details/" + i.id}>
                                <Card name={i.name} image={i.image} nickName={i.nickName} key={i.id}></Card>
                            </Link>
                        </>
                    );
                })}
